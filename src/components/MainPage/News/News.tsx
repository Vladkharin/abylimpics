      ...
      <div className={styles.container}>
        ...
        <div className={styles.wrapper}>
          <a className={styles.tile} href="">
            <div>
              <img src="./assets/img/first_news.png" alt="news" />
            </div>
            <div className={styles.texts}>
              <div className={styles.date}>12 ноя 2024</div>
              <p className={styles.descr}>
                Команда из Оренбурга завоевала 2 золота, 2 серебра и 5 бронз. Участвовали студенты, специалисты и участник СВО.
              </p>
            </div>
          </a>
        ...
        <div className={styles.wrapper}>
          <div className={firstStateMenu ? styles.main_information_open : styles.main_information_close}>
            <p style={{ color: firstStateMenu ? "#0540f2" : "#000000" }}>
              От Оренбургской области в Национальном чемпионате примут участие 18 конкурсантов, прошедших отборочный этап, а также 6
              победителей регионального чемпионата 2024 года:
            </p>
            <button onClick={() => (firstStateMenu ? setFirstStateMenu(false) : setFirstStateMenu(true))}>
              <img src="./assets/icons/arrow.svg" alt="" />
            </button>
          </div>
          <div className={firstStateMenu ? styles.main_information_show : styles.main_information_hide}>
            <div className={firstStateMenu ? styles.descr_wrapper_show : styles.descr_wrapper_hide}>
              <p className={styles.descr}>
                <span>- Гайибова Назира Закиржоновна</span>, участник по компетенции «Банковское дело» в категории «Школьники» от МОАУ
                «Средняя общеобразовательная школа № 35» г. Оренбурга, наставник Гантова Ольга Юрьевна;
              </p>
              <p className={styles.descr}>
              ...
              <p className={styles.descr}>
                ...
                «Специальная (коррекционная) общеобразовательная школа-интернат» г. Новотроицка Оренбургской области, наставник Курзина
                Ирина Николаевна;
              </p>
              <p className={styles.descr}>
              ...
              <p className={styles.descr}>
                <span>- Радченко Егор Алексеевич</span>, участник по компетенции «Ландшафтный дизайн» в категории «Школьники» от МОАУ
                «Средняя общеобразовательная школа № 35» г. Оренбурга, наставник Нетёса Татьяна Евгеньевна;
              </p>
              <p className={styles.descr}>
              ...
              <p className={styles.descr}>
                <span>- Кудинов Михаил Алексеевич</span>, участник по компетенции «Малярное дело» в категории «Школьники» от ГБОУ
                «Специальная (коррекционная) общеобразовательная школа-интернат» г. Новотроицка Оренбургской области, наставник Косенок
                Татьяна Петровна;
              </p>
              <p className={styles.descr}>
              ...
              <p className={styles.descr}>
                <span>- Швардыгула Илья Сергеевич</span>, участник по компетенции «Ремонт и обслуживание автомобиля» в категории
                «Специалисты» от Оренбургского регионального отделения Общероссийской общественной организации инвалидов «Всероссийское
                общество глухих»;
              </p>
              <p className={styles.descr}>
                <span>- Невзоров Михаил Сергеевич</span>, участник по компетенции «Ремонт и обслуживание автомобиля» в категории «Студенты»
                от ГАПОУ «Новотроицкий строительный техникум», наставник Горшенина Наталья Александровна;
              </p>
              <p className={styles.descr}>
                <span>- Безмельницын Дмитрий Викторович</span>, участник по компетенции «Сухое строительство и штукатурные работы» в
                категории «Специалисты» от Оренбургского регионального отделения Общероссийской общественной организации инвалидов
